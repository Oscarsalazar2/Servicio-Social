...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                {/* Esta es la bola roja que se degrada
                <img
                    id="background"
                            ...
                            <nav className="flex items-center">
                                {auth.user ? (
                                    ...
                                    <>
                                        <Link
                                            href={route("login")}
                                            /*className="ml-3 rounded-md bg-[#FFFFFF] px-4 py-2 text-black font-semibold ring-1 ring-white/30 transition hover:bg-white/10"*/
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <a
                                  ...
                                  //className="flex flex-col items-center justify-center text-center gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:col-span-2 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                   // className="flex flex-col items-center justify-center text-center gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:col-span-2 max-w-xl mx-auto lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                >
                                    {/*Este es el icono*/}
                                    {/*<div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        <h2 className="text-xl font-normal text-black dark:text-white">
                                            Consulta en tiempo real las condiciones climatologicas 
                                            dentro del Instituto Tecnológico de Matamoros a través 
                                            de esta estación meteorológica que recolecta datos ambientales.
                                        </h2>
                                    </div>
                                    {/*Esta es la flecha*/}
                                    {/*<svg 
 ...
 {/*
                        ...
                        <footer className="py-16 text-center text-sm mt-16 text-black dark:text-white/70">
                            ...
                            Instituto Tecnológico de Matamoros &copy; {new Date().getFullYear()}
                        </footer>
                    </div>
                </div>
